...
import { PhoneIcon, ChatBubbleLeftIcon, EnvelopeIcon } from "@heroicons/vue/24/outline";
...
const SectionTitle = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["ssrRender", _sfc_ssrRender$4]]);
const _sfc_main$M = {
...
const SectionBorder = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$A = {
  __name: "TextInput",
  __ssrInlineRender: true,
  props: {
...
const ApplicationMark = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$x = {
  __name: "Banner",
  __ssrInlineRender: true,
  setup(__props) {
...
const AuthenticationCard = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$o = {
...
const ApplicationLogo = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender]]);
const _sfc_main$f = {
  __name: "Welcome",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main$c = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Online Coding Lessons" }, null, _parent));
      _push(`<div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white"><div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2"><div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48"><div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg"><div class="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2"><svg class="absolute inset-0 h-full w-full stroke-gray-700 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" aria-hidden="true"><defs><pattern id="54f88622-e7f8-4f1d-aaf9-c2f5e46dd1f2" width="200" height="200" x="100%" y="-1" patternUnits="userSpaceOnUse"><path d="M130 200V.5M.5 .5H200" fill="none"></path></pattern></defs><svg x="100%" y="-1" class="overflow-visible fill-gray-800/20"><path d="M-470.5 0h201v201h-201Z" stroke-width="0"></path></svg><rect width="100%" height="100%" stroke-width="0" fill="url(#54f88622-e7f8-4f1d-aaf9-c2f5e46dd1f2)"></rect></svg><div class="absolute -left-56 top-[calc(100%-13rem)] transform-gpu blur-3xl lg:left-[max(-14rem,calc(100%-59rem))] lg:top-[calc(50%-7rem)]" aria-hidden="true"><div class="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-br from-[#80caff] to-[#4f46e5] opacity-20" style="${ssrRenderStyle({ "clip-path": "polygon(74.1% 56.1%, 100% 38.6%, 97.5% 73.3%, 85.5% 100%, 80.7% 98.2%, 72.5% 67.7%, 60.2% 37.8%, 52.4% 32.2%, 47.5% 41.9%, 45.2% 65.8%, 27.5% 23.5%, 0.1% 35.4%, 17.9% 0.1%, 27.6% 23.5%, 76.1% 2.6%, 74.1% 56.1%)" })}"></div></div></div><h2 class="text-3xl font-bold tracking-tight text-white">Live Online Classes</h2><p class="mt-6 text-lg leading-8 text-gray-300">These classes are ideal for home-taught children who would benefit from a basic grounding in web coding. There is a maximum of 6 students to a class and prices start at £5 per lesson.</p><p class="mt-6 text-lg leading-8 text-gray-300">Here are the current lessons available:</p><ul class="mt-10 space-y-8 text-base leading-7 text-gray-300"><li><div class="flex justify-between items-end text-xl font-bold"><h2>HTML &amp; CSS</h2><div class="text-sm uppercase">Intro</div></div><p>Start at the beginning. Learn the fundamentals of website building.</p><div>learn: html, css</div><a class="underline underline-offset-4" href="https://headstartcoding.com/">more information</a></li><li><div class="flex justify-between items-end text-xl font-bold"><h2>Yahtzee Clone</h2><div class="text-sm uppercase">Novice</div></div><p>Learn how to use logic and data to build a dice-rolling game.</p><div>learn: vue (javascript), tailwind (css)</div></li><li><div class="flex justify-between items-end text-xl font-bold"><h2>Asteroids Clone</h2><div class="text-sm uppercase">Intermediate</div></div><p>Learn how to use the Canvas element to build a classic game.</p><div>learn: vue (javascript), tailwind (css)</div></li><li><div class="flex justify-between items-end text-xl font-bold"><h2>Hog dice game</h2><div class="text-sm uppercase">Intermediate</div></div><p>Learn how to use build a game in the computer terminal.</p><div>learn: python</div></li></ul></div></div><div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48"><div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg"><div class="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2"><svg class="absolute inset-0 h-full w-full stroke-gray-700 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" aria-hidden="true"><defs><pattern id="54f88622-e7f8-4f1d-aaf9-c2f5e46dd1f2" width="200" height="200" x="100%" y="-1" patternUnits="userSpaceOnUse"><path d="M130 200V.5M.5 .5H200" fill="none"></path></pattern></defs><svg x="100%" y="-1" class="overflow-visible fill-gray-800/20"><path d="M-470.5 0h201v201h-201Z" stroke-width="0"></path></svg><rect width="100%" height="100%" stroke-width="0" fill="url(#54f88622-e7f8-4f1d-aaf9-c2f5e46dd1f2)"></rect></svg><div class="absolute -left-56 top-[calc(100%-13rem)] transform-gpu blur-3xl lg:left-[max(-14rem,calc(100%-59rem))] lg:top-[calc(50%-7rem)]" aria-hidden="true"><div class="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-br from-[#80caff] to-[#4f46e5] opacity-20" style="${ssrRenderStyle({ "clip-path": "polygon(74.1% 56.1%, 100% 38.6%, 97.5% 73.3%, 85.5% 100%, 80.7% 98.2%, 72.5% 67.7%, 60.2% 37.8%, 52.4% 32.2%, 47.5% 41.9%, 45.2% 65.8%, 27.5% 23.5%, 0.1% 35.4%, 17.9% 0.1%, 27.6% 23.5%, 76.1% 2.6%, 74.1% 56.1%)" })}"></div></div></div><h2 class="text-3xl font-bold tracking-tight text-white">Get in touch</h2><p class="mt-6 text-lg leading-8 text-gray-300">To find out more please contact me or join a classroom.</p><dl class="mt-10 space-y-4 text-base leading-7 text-gray-300"><div class="flex gap-x-4"><dt class="flex-none"><span class="sr-only">Telephone</span>`);
      _push(ssrRenderComponent(unref(PhoneIcon), {
        class: "h-7 w-6 text-gray-400",
        "aria-hidden": "true"
      }, null, _parent));
      _push(`</dt><dd><a class="hover:text-white" href="tel:0151 324 0496">0151 324 0496</a></dd></div><div class="flex gap-x-4"><dt class="flex-none"><span class="sr-only">Telephone</span>`);
      _push(ssrRenderComponent(unref(PhoneIcon), {
        class: "h-7 w-6 text-gray-400",
        "aria-hidden": "true"
      }, null, _parent));
      _push(`</dt><dd><a class="hover:text-white" href="tel:07515 382159">07515 382159</a></dd></div><div class="flex gap-x-4"><dt class="flex-none"><span class="sr-only">Telephone</span>`);
      _push(ssrRenderComponent(unref(ChatBubbleLeftIcon), {
        class: "h-7 w-6 text-gray-400",
        "aria-hidden": "true"
      }, null, _parent));
      _push(`</dt><dd><a class="hover:text-white" href="tel:07515 382159">07515 382159</a></dd></div><div class="flex gap-x-4"><dt class="flex-none"><span class="sr-only">Email</span>`);
      _push(ssrRenderComponent(unref(EnvelopeIcon), {
        class: "h-7 w-6 text-gray-400",
        "aria-hidden": "true"
      }, null, _parent));
      _push(`</dt><dd><a class="hover:text-white" href="mailto:sharif.khan@mac.com">sharif.khan@mac.com</a></dd></div></dl></div></div></div></div><!--]-->`);
    };
  }
};
const _sfc_setup$c = _sfc_main$c.setup;
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/LiveLessons.vue");
  return _sfc_setup$c ? _sfc_setup$c(props, ctx) : void 0;
};
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white"><div class="max-w-7xl text-xl mx-auto p-6 lg:p-8 dark:text-gray-200 flex flex-col justify-around"><div class="flex flex-col"><h1>Sharif Khan</h1><h2 class="font-bold text-2xl">UK Based Laravel contractor</h2><p>Specialising in portals and intranets.</p><a class="underline underline-offset-4" href="https://www.linkedin.com/in/shaky-coder/">LinkedIn profile</a><a class="underline underline-offset-4" href="https://www.youtube.com/@theshakycoder">YouTube Channel</a></div><div class="flex flex-col mt-12"><h2 class="font-bold text-2xl">Specialties</h2><div>Laravel</div><div>inertia.js</div><div>vue.js</div></div><div class="flex flex-col mt-12"><h2 class="font-bold text-2xl">Concept Sites</h2><div><a class="underline underline-offset-4" href="https://dev.stupidly.uk">Stupidly</a> Bookkeeping App</div></div><div class="flex flex-col mt-12"><h2 class="font-bold text-2xl">Games</h2><div><a class="underline underline-offset-4" href="/dodge">Dodge</a> (first attempt)</div><div><a class="underline underline-offset-4" href="/asteroids">Asteroids</a> (my take on an old classic)</div></div><div class="flex flex-col mt-12"><h2 class="font-bold text-2xl">Online Training</h2><div><a class="underline underline-offset-4" href="/live-lessons">Live Lessons</a></div></div></div></div><!--]-->`);
    };
  }
};
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/API/Index.vue": __vite_glob_0_0, "./Pages/API/Partials/ApiTokenManager.vue": __vite_glob_0_1, "./Pages/Asteroids/Index.vue": __vite_glob_0_2, "./Pages/Auth/ConfirmPassword.vue": __vite_glob_0_3, "./Pages/Auth/ForgotPassword.vue": __vite_glob_0_4, "./Pages/Auth/Login.vue": __vite_glob_0_5, "./Pages/Auth/Register.vue": __vite_glob_0_6, "./Pages/Auth/ResetPassword.vue": __vite_glob_0_7, "./Pages/Auth/TwoFactorChallenge.vue": __vite_glob_0_8, "./Pages/Auth/VerifyEmail.vue": __vite_glob_0_9, "./Pages/Dashboard.vue": __vite_glob_0_10, "./Pages/Dodge/Index.vue": __vite_glob_0_11, "./Pages/LiveLessons.vue": __vite_glob_0_12, "./Pages/LunarLander/Index.vue": __vite_glob_0_13, "./Pages/LunarLander/Index3.vue": __vite_glob_0_14, "./Pages/PrivacyPolicy.vue": __vite_glob_0_15, "./Pages/Profile/Partials/DeleteUserForm.vue": __vite_glob_0_16, "./Pages/Profile/Partials/LogoutOtherBrowserSessionsForm.vue": __vite_glob_0_17, "./Pages/Profile/Partials/TwoFactorAuthenticationForm.vue": __vite_glob_0_18, "./Pages/Profile/Partials/UpdatePasswordForm.vue": __vite_glob_0_19, "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": __vite_glob_0_20, "./Pages/Profile/Show.vue": __vite_glob_0_21, "./Pages/TermsOfService.vue": __vite_glob_0_22, "./Pages/Welcome.vue": __vite_glob_0_23 });
